...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/Applications/MAMP/htdocs/prestashop/modules/psxdesign/src/Entity']);
        $e->addExcludePaths([0 => '/Applications/MAMP/htdocs/prestashop/modules/psxdesign/src/Entity/index.php']);
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/Applications/MAMP/htdocs/prestashop/modules/productcomments/src/Entity']);
        $f->addExcludePaths([0 => '/Applications/MAMP/htdocs/prestashop/modules/productcomments/src/Entity/index.php']);
        $g = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/Applications/MAMP/htdocs/prestashop/modules/ps_checkout/src/Entity']);
        $g->addExcludePaths([0 => '/Applications/MAMP/htdocs/prestashop/modules/ps_checkout/src/Entity/index.php']);

        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/Applications/MAMP/htdocs/prestashop/src/PrestaShopBundle/Entity']), 'PrestaShop');
        $c->addDriver($e, 'PrestaShop\\Module\\PsxDesign\\Entity');
        $c->addDriver($f, 'PrestaShop\\Module\\ProductComment\\Entity');
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/Applications/MAMP/htdocs/prestashop/modules/ps_accounts/src/Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
    ...
    {
        return $this->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('/Applications/MAMP/htdocs/prestashop', '/Applications/MAMP/htdocs/prestashop/modules/');
    }
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('8.1.4', '/Applications/MAMP/htdocs/prestashop', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('8.1.4', '/Applications/MAMP/htdocs/prestashop');
    }
